...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
    ...
    'afterAjaxUpdate'=>"function() {sortGrid('partner')}",
...
<?php if($model->hasAttribute('sort')) Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("partner");', CClientScript::POS_END) ;?>