<?php
/**
 * Миграция m140330_065811_create_news
 *
 * @property string $prefix
 */
 
class m140330_065811_create_news extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('tbl_news');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('tbl_news', array(
			...
			'name' => "VARCHAR(255) COMMENT 'Заголовок'",
			'gllr_photos' => "INT COMMENT 'Изображения'",
			'dt_date' => "DATETIME COMMENT 'Дата'",
